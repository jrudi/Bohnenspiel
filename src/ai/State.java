...
public class State {
  ...
  /**
   * gibt den Wert der Heuristik für den aktuellen Spielzustand zurueck startGegner/start speichert
   * welcher Teil des Feldes der KI geh�rt nullFeld wird erh�ht wenn der Gegner ein Feld ohne Bohnen
   * hat nichtNullFeld
   * 
   * @return
   */
